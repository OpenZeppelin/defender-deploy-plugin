<script lang="ts">
    ...
    import Dropdown from "../../remix/components/shared/Dropdown.svelte";
...
<div class="flex flex-col gap-4 space-y-2">
  <div class="form-check">
    ...
    {#key globalState.form.approvalProcessSelected}
      ...
      /> -->
      <div class="pl-5"><Select options={globalState.approvalProcesses
        .filter(approvalProcessByNetworkAndComponent)
        .map(approvalProcessToDropdownItem)} /></div>
    {/key}
  </div>
  <div
  ...
  ><div class="flex items-center gap-2">
    ...
    /> -->
    <div class="pl-5 space-y-2"><Select options={approvalProcessTypes.map(approvalProcessTypeToDropdownItem)} />
